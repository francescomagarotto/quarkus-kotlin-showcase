...
with: `./target/quarkus-kotlin-showcase-1.0-SNAPSHOT-runner`
...
- RESTEasy Classic Mutiny ([guide](https://quarkus.io/guides/resteasy#reactive)): Mutiny support for
  RESTEasy Classic server
